...
5. **Regularized Modeling:** Deployed an $L_1$-Penalized (Lasso) Logistic Regression solver (`liblinear`) to  address the "Curse of Dimensionality" ($54,675 \text{ features} \gg 96 \text{ training samples}$) and avoid over-fitting.
